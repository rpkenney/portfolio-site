...
def static_page_context(
    ...
    *,
    ...
    css_href, js_content_frame_href, js_carousel_href, js_langton_ant_href = asset_hrefs(route.depth)
    nav = nav_for(
        route.nav_page,
        route.depth,
        items=nav_bar_items,
    ...
    content_frame = route.nav_page == "home"
    return {
        **base,
        "page_title": route.page_title,
        "nav": nav,
        "css_href": css_href,
        "js_content_frame_href": js_content_frame_href if content_frame else None,
        "js_carousel_href": js_carousel_href,
        "js_langton_ant_href": js_langton_ant_href,
